...
function mySISView1() {
    document.getElementById("qcor").style.display = "inline";  // For QCOR.
    document.getElementById("rm").style.display = "none";
}

function mySISView2() {
    document.getElementById("qcor").style.display = "none";
    document.getElementById("rm").style.display = "inline";  // For RM
}

function mySISView3() {
    document.getElementById("qcor").style.display = "none";
    document.getElementById("rm").style.display = "none"; 
    document.getElementById("qcoram").style.display = "inline";  // QCORAM
...
function mySISView4() {
    ...
    document.getElementById("peakcall").style.display = "inline";  // peak call
...
function mySISView5() {
    ...
    document.getElementById("mota").style.display = "inline";  // motif ana
...
function mySISView6() {
    ...
    document.getElementById("peakanno").style.display = "inline";  // peak anno
...
function mySISView7() {
    ...
    document.getElementById("db").style.display = "inline";         //diff binding
...
function mySISView8() {
    ...
    document.getElementById("goa").style.display = "inline";         //goa
